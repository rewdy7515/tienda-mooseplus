// Core compartido de plantillas de notificaciones.
// Se expone para navegador (globalThis.NotificationTemplatesCore)
// y para Node.js (module.exports), para mantener una sola fuente.
(function initNotificationTemplatesCore(root, factory) {
  const api = factory();
  ...
  const buildNotification = (tipo, data = {}) => {
