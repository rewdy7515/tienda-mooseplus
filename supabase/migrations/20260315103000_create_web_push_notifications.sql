...
create index web_push_subscriptions_id_usuario_idx
...
create table public.web_push_delivery_queue (
...
create index web_push_delivery_queue_estado_idx
  on public.web_push_delivery_queue (estado, id_queue);

create index web_push_delivery_queue_subscription_idx
